...
import ispm from "../images/ispm.jpg";
import freelance from "../images/freelance.jpg";
import myagency from "../images/myagency.jpg";
		...
		return {
			timelineData: [
				...
				},
				{
					...
					icon: "pencil-alt",
					date: "2014",
					lottie: "https://embed.lottiefiles.com/animation/67928",
				},
				{
					title: "Freelancing",
					content:
					...
					icon: "palette",
					date: "2017",
					lottie: "https://embed.lottiefiles.com/animation/48055",
				},
				{
					title: "MyAgency",
					content:
					...
					icon: "laptop",
					date: "2021",
					lottie: "https://embed.lottiefiles.com/animation/17245",
				},
			],
		};
	},
